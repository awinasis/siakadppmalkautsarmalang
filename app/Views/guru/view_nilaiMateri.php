             ...
             <div class="box box-warning box-solid">
                 <div class="box-header with-border">
                     <div class="note note-info">
                         <h4 class="block"><b>Petunjuk :</b></h4>
                     </div>
                 </div>
             </div>
         </div>
         ...
         <div class="col-sm-12">
             <div class="nav-tabs-custom">
                 <ul class="nav nav-tabs">
                     <li class="active"><a href="#Reguler" data-toggle="tab">Reguler</a></li>
                     <li><a href="#Hadits_Besar" data-toggle="tab">Hadits Besar</a></li>
                 </ul>
                 <div class="tab-content">
                     <div class="active tab-pane" id="Reguler">
                     ...
                     <div class="tab-pane" id="Hadits_Besar">
                         <div class="box box-gray box-solid">
                             <div class="box-header with-border">
                                 <!-- <div class="box-tools pull-left"> -->
                                 <a href="<?= base_url('data_nilai/tambahNilaiMateri/') ?>" class="btn btn-primary btn-sm"><i class="fa fa-plus"> Tambah</i></a>
