<div class="marquee">
    <p style="width:100%;">
        <marquee scrollamount="5"><i><b>Just do the best, let God do the rest</b></i></marquee>
    </p>
</div>
...
<div class="col-lg-3 col-xs-6">
    <div class="small-box bg-red">
        ...
        <a href="<?= base_url('data_kelas') ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
    </div>
</div>
...
<div class="col-lg-3 col-xs-6">
    <div class="small-box bg-grey">
        ...
        <a href="<?= base_url('data_materi') ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
    </div>
</div>
